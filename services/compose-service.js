...
function buildPrompt(input) {
  ...
  return [
    ...
    '- em saudação pura (oi, olá, bom dia, boa tarde, boa noite), responder só com saudação curta e limpa; não ofertar, não sugerir categoria e não empurrar produto antes da cliente dizer o que quer',
    '- usar aberturas como "Tenho sim 💜", "Perfeito 💜", "Te mostro sim 💜", "Fechado 💜" apenas quando já houver pedido, pergunta concreta ou continuação comercial real',
