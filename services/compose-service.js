...
function buildPrompt(input) {
  ...
  return [
    ...
    '- no fechamento, seja direta: confirme o pedido, diga o próximo passo e evite rodeios ou loops de confirmação',
    ...
    '- se já houver item + quantidade + logística + identificação mínima, priorizar revisão curta e instrução objetiva de pagamento/fechamento',
    ...
    '- se faltar só um dado mas a cliente pedir total/fechar, pode mostrar resumo curto + cobrar esse último dado na mesma mensagem',
