...
function getStoreFacts() {
  ...
  return {
    ...
    inPersonRule: 'somente com horário marcado',
    shipsOnlyUs: true,
    shippingRegion: 'Estados Unidos',
    paymentMethods: ['Zelle', 'Venmo', 'AfterPay', 'Cartão de crédito', 'Apple Pay', 'Cash App', 'Link de pagamento'],
